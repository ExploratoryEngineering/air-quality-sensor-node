...
#define OPC_SAMPLING_PERIOD_INDEX     52  // Sampling period is a 16 bit unsigned integer and 
                                        // is a measure of the histogram's actual sampling period in seconds x 100
...
uint16_t OPC_calcCRC(uint8_t data[], uint8_t n);
